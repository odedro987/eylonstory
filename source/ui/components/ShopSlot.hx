...
class ShopSlot extends FlxTypedGroup<FlxBasic>
{
	...
	public function new(x:Float, y:Float, id:Int, bowData:BowSlotData, mesosMultiplier:Float, ?onClick:Int->Void)
	{
		super(5);
		...
		this.y = y;
		this.id = id;
		this.bowIndex = bowData.bowIndex;
